...
# output directed to file:               ./Results_Integron_Finder_KP345882.1/other/KP345882.1_57944_62144_subseq_attc.res
# tabular output of hits:                ./Results_Integron_Finder_KP345882.1/other/KP345882.1_57944_62144_subseq_attc_table.res
...
Hit scores:
 ...
 ----   --------- ------ -----  ---------- ------ ------   --- ----- ----  -----------
 ------ inclusion threshold ------
  (1) ?       3.6   11.6   0.0  KP345882.1    901    952 +  cm    no 0.56  Escherichia coli strain BK32533 plasmid pBK32533, complete sequence
...
>> KP345882.1  Escherichia coli strain BK32533 plasmid pBK32533, complete sequence
 ...
 ----   --------- ------ ----- --- -------- --------    ----------- -----------      ------ ----- ----
  (1) ?       3.6   11.6   0.0  cm        1       47 []         901         952 + ..   11.1    no 0.56

                                                          NC
                 <<<<<<<--------<~~~~~~>---------->>>>>>> CS
      attC_4   1 GcCUAACAAgUCAUUG*[13]*CUCgGcCAUUCGUUAGgC 47 
                 GC: AAC   +C   G      CUC GC     GUU :GC
  KP345882.1 901 GCUGAACCCAGC---G*[26]*CUCCGC-----GUUCAGC 952
                 [Rsec=]========[~~~~~~]==========[Rprim] RF
