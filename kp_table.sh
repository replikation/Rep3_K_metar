...
printf "accession;organism;description;basepairs;date;country;plasmid_name;kpc_type;inc_type\n" > plasmid_table.csv
for x in plasmid_files/*.fasta; do
    ...
    printf "$accnum;$org;${desc//;};$basepairs;${date//;};${country//;};${plasmidname//;};${kpc_type//;};${inc_type}\n" >> plasmid_table.csv
done
